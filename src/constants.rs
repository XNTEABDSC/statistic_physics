...
pub const NUMINV2:Num=Num::strict_shr(Num::ONE, 1);

pub const NUM2:Num=Num::strict_shr(Num::ONE, 1);
pub const NUM4:Num=Num::strict_shr(Num::ONE, 2);
pub const NUM8:Num=Num::strict_shr(Num::ONE, 3);
pub const NUM16:Num=Num::strict_shr(Num::ONE, 4);
pub const NUM32:Num=Num::strict_shr(Num::ONE, 5);
/// 32=2^5
...
pub const HALF_LIFE_PERIOD_FRAME:Num=Num::strict_mul(HALF_LIFE_PERIOD_SECOND, FRAME_PER_SECOND);
...
pub const HALF_LIFE_PERIOD_FRAME_FACTOR:Num=Num::strict_div(Num::LN_2, HALF_LIFE_PERIOD_FRAME);

/// HALF_LIFE_PERIOD_FRAME_FACTOR/2
/// mult this to 2 value delta per frame to make 2 value approach eachother
pub const HALF_LIFE_PERIOD_FRAME_FACTOR_OVER2:Num=Num::strict_shr(HALF_LIFE_PERIOD_FRAME_FACTOR, 1);

pub const SECOND_PER_FRAME:Num=mut_second_per_frame(Num::ONE);

pub const INV_HALF_LIFE_PERIOD:Num=Num::strict_div(Num::ONE,HALF_LIFE_PERIOD_SECOND);
//length of grid
